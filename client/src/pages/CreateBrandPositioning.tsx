    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-background">
      ...
      <header className="border-b bg-background/95 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          ...
          <h1 className="text-xl font-bold">ブランドポジショニング作成</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              ...
              {currentStep === 7 && "レポート生成"}
              {currentStep === 8 && "完了"}
            </CardTitle>
            <CardDescription>
              {currentStep === 1 && "ブランドの基本情報を入力してください"}
              {currentStep === 2 && "ブランドのインスピレーション源を教えてください"}
              {currentStep === 3 && "ターゲットとする顧客像を詳しく教えてください"}
              {currentStep === 4 && "主要な競合企業を入力してください"}
              {currentStep === 5 && "ブランドの核となる価値観を定義してください"}
              {currentStep === 6 && "ブランドを最もよく表すアーキタイプを選択してください"}
                ...
                <div className="space-y-2">
                  ...
                  >
                    {BRANDING_TYPES.map((type) => (
                      <div key={type.value} className="flex items-center space-x-2 border rounded-lg p-4">
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="inspiration"
                    placeholder="ブランドのインスピレーション源、参考にしている企業やブランド、目指す方向性などを自由に記述してください..."
                    rows={8}
